...
export default (callback: IEmptyFunction): void => {
  ...
  new AssetLoader([atlas]).then(() => {
    ...
    sd.cutOut('bird-yellow-up', 6, 982, 34, 38);
    sd.cutOut('bird-yellow-mid', 62, 982, 34, 38);
    sd.cutOut('bird-yellow-down', 118, 982, 34, 38);
    sd.cutOut('bird-blue-up', 174, 982, 34, 38);
    sd.cutOut('bird-blue-mid', 230, 658, 34, 38);
    sd.cutOut('bird-blue-down', 230, 710, 34, 38);
    sd.cutOut('bird-red-up', 230, 762, 34, 38);
    sd.cutOut('bird-red-mid', 230, 814, 34, 38);
    sd.cutOut('bird-red-down', 230, 866, 34, 38);
    ...
    sd.cutOut('banner-flappybird', 583, 695, 352, 145);
